...
class CityLookupTest {
	...
	try {
	    LookupService cl = new LookupService("F:/SpringWorkspace/GeoTest/src/GeoLiteCity.dat", //"/usr/local/share/GeoIP/GeoIPCity.dat",
					LookupService.GEOIP_MEMORY_CACHE );
            Location l1 = cl.getLocation("58.102.122.225");
            Location l2 = cl.getLocation("58.102.122.225");
